...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>仪表板</a>
    <ul>
        ...
        <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>窗口小部件</span></a> </li>
        <li><a href="#/table"><i class="icon icon-th"></i> <span>表格</span></a></li>
        <li><a href="grid.html"><i class="icon icon-fullscreen"></i> <span>全宽度</span></a></li>
        <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>形式</span> <span class="label label-important">3</span></a>
            <ul>
                <li><a href="form-common.html">基本表单</a></li>
                <li><a href="form-validation.html">表单验证</a></li>
                <li><a href="form-wizard.html">表格向导</a></li>
            </ul>
        </li>
        ...
        <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>插件</span> <span class="label label-important">5</span></a>
            <ul>
                <li><a href="index2.html">仪表板2</a></li>
                <li><a href="gallery.html">画廊</a></li>
                <li><a href="calendar.html">日历</a></li>
                <li><a href="invoice.html">发票联</a></li>
                <li><a href="chat.html">聊天选项</a></li>
            </ul>
        </li>
...
<script src="/console/angular/app.js"></script>
<script src="/console/angular/os.js"></script>
