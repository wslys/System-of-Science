...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/js/progress-bar/number-pb.css">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul style="margin: 11px 0 0 9px;" role="menu" class="dropdown-menu dropdown-wrap">
                        <li>
                            <a href="#">
                                <img alt="" class="img-msg img-circle" src="/img/photo/4.jpg">Jhon Doe <b>Just Now</b>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <img alt="" class="img-msg img-circle" src="/img/photo/4.jpg">Jeniffer <b>3 Min Ago</b>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <img alt="" class="img-msg img-circle" src="/img/photo/4.jpg">Dave <b>2 Hours Ago</b>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <img alt="" class="img-msg img-circle" src="/img/photo/4.jpg"><i>Keanu</i>  <b>1 Day Ago</b>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <img alt="" class="img-msg img-circle" src="/img/photo/4.jpg"><i>Masashi</i>  <b>2 Mounth Ago</b>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
            ...
            <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                <li>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" class="admin-pic img-circle" src="/img/photo/photo.jpg">Hi, Dave Mattew <b class="caret"></b>
                    </a>
...
<div id="skin-select">
    <div id="logo">
        <h1>硬件平台&nbsp;&nbsp;<span class="text-center">v1.2</span></h1>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <ul class="chat">
                    <li>
                        <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-circle" src="/img/photo/4.jpg">
                    ...
                    <li>
                        <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-circle" src="/img/photo/22.jpg">
                ...
                <ul class="chat">
                    <li>
                        <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="/img/photo/23.jpg">
                                </span><b>Dave Junior</b>
                            <br><i>Last seen : 08:00 PM</i>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                                <span>
                                    <img alt="" class="img-chat img-offline img-circle" src="/img/photo/4.jpg">
                                </span><b>Kenneth Lucas</b>
                            <br><i>Last seen : 07:21 PM</i>
                        </a>
                    </li>
...
<script src="/js/progress-bar/src/jquery.velocity.min.js"></script>
<script src="/js/progress-bar/number-pb.js"></script>
<script src="/js/progress-bar/progress-app.js"></script>
...
<!-- GAGE -->
<script type="text/javascript" src="/js/chart/jquery.flot.js"></script>
<script type="text/javascript" src="/js/chart/jquery.flot.resize.js"></script>
<script type="text/javascript" src="/js/chart/realTime.js"></script>
<script type="text/javascript" src="/js/speed/canvasgauge-coustom.js"></script>
<script type="text/javascript" src="/js/countdown/jquery.countdown.js"></script>



<script src="/js/jhere-custom.js"></script>
