...
<head>
    ...
    <link rel="stylesheet" href="/home/test/tree.css" />
...
<div id="sidebar">
    ...
    <ul>
        ...
        <li> <a href="#/test"><i class="icon icon-signal"></i> <span>开发者</span></a> </li>
...
<!-- ngJsTree -->
<!--<script src="/lib/angular-bootstrap-nav-tree/abn_tree.js"></script>-->
<!--<script src="/lib/jstree/3.2.1/jstree.js"></script>-->
<!--<script src="/lib/ngJsTree/0.0.8/ngJsTree.js"></script>-->

<script src="os/app.js"></script>
<script src="os/service.js"></script>
<script src="os/directive.js"></script>
<script src="os/os.js"></script>
